 ...
 * @LastEditTime: 2020-11-16 11:44:42
 * @FilePath: /Linux-Program-APP/07_freetype/02_freetype_show_font/freetype_show_font_angle.c
 */
#include <sys/mman.h>
#include <sys/types.h>
#include <sys/stat.h>
...
int main(int argc, char *argv[])
{
	...
	wchar_t *chinese = L"福禄寿jpeg";

	if(argc == 3)
		angle = (strtoul(argv[2], NULL, 0) * 1.0 / 360) *3.14159 * 2;
